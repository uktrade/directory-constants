SECTORS = [
    ...
    (
        'INORGANIC CHEMICALS; ORGANIC AND INORGANIC COMPOUNDS OF '
    ...
    (
        'FABRICS; SPECIAL WOVEN FABRICS, TUFTED TEXTILE FABRICS, LACE, '
    ...
    (
        'FEATHERS AND DOWN, PREPARED; AND ARTICLES MADE OF FEATHER OR OF DOWN;'
